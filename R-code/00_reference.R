...
FILE_SOMASCAN  <- file.path(DATA_DIR, "CruchagaLab_CSF_SOMAscan7k_Protein_matrix_postQC_20230620.xlsx")
FILE_DUKE_UPLC <- file.path(DATA_DIR, "f01_duke_uplc.xlsx")
FILE_LEIDEN_HPH <- file.path(DATA_DIR, "f02a_leiden_hph.xlsx")
FILE_LEIDEN_LPH <- file.path(DATA_DIR, "f02b_leiden_lph.xlsx")
FILE_DUKE_METAB <- file.path(DATA_DIR, "f03_duke_metabolon.xlsx")
FILE_NPI       <- file.path(DATA_DIR, "f04_npi.xlsx")
FILE_NPIQ      <- file.path(DATA_DIR, "f05_npiq.xlsx")
FILE_MEDHIST   <- file.path(DATA_DIR, "f06_medhist.xlsx")
FILE_BHR_BL    <- file.path(DATA_DIR, "f07_bhr_baseline.xlsx")
FILE_BHR_LONG  <- file.path(DATA_DIR, "f08_bhr_longitudinal.xlsx")
FILE_BHR_CG    <- file.path(DATA_DIR, "f09_bhr_caregiver.xlsx")
FILE_PTDEMOG   <- file.path(DATA_DIR, "f10_ptdemog.xlsx")
FILE_LIFESTYLE <- file.path(DATA_DIR, "lifestyle_dictionary.xlsx")
